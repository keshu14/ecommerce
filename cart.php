            ...
            <button type="submit" class="btn btn-info">+</button>
                            ...
                            <?php endforeach; ?> 
                                ...
                                <tr>
                                    ...
                                    <td colspan="2" class="text-primary"><?php echo number_format($total - $gst,2) ?></td>
                                </tr>
                                <tr>
                                    <td colspan="3" class="text-right"><strong>GST (5%)</strong></td>
                                    <td colspan="2" class="text-danger"><?php echo number_format($gst,2) ?></td>
                                </tr>
                                <tr>
				...
				<div class="col-sm-3">
       <img src="images/cart.png" alt="" class="img-responsive"/>
        </div>
			</div>
		</div>
	</section><!--/form-->
